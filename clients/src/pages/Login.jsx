    ...
    <div className='bg-[#ffffff] w-[100vw] h-[100vh] flex justify-center items-center'>
      <div className='w-[90%] sm:w-[400px] pl-0 ml-0 h-[400px] sm:pl-0 sm:ml-9 mt-20 relative'>
        ...
        <form className='flex flex-col gap-y-3 mt-[12%]' onSubmit={formSubmit}>
          <div>
            <input
              className="w-[100%] sm:w-[80%] bg-[#f0f0f0] h-[50px] pl-3 text-[#000]"
          ...
          <div className='relative'>
            ...
            />
            {
              !showPass ? (
                <button type='button'>
                  <BsEmojiLaughing onClick={() => setShowPass(!showPass)} className='text-[#000] absolute top-3 right-5 sm:right-24 w-[30px] h-[25px]' />
                </button>
              ) : (
                <button type='button'>
                  <BsEmojiExpressionless onClick={() => setShowPass(!showPass)} className='text-[#000] absolute top-3 right-5 sm:right-24 w-[30px] h-[25px]' />
                </button>
              )
            }
          </div>
          ...
          >
            ...
            <p style={{ display: isLoading ? "none" : "block" }} className='test-[#000]'>Login</p>
          </button>
