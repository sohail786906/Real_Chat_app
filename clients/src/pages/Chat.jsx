...
function Chat(props) {
  ...
  // Function to handle keydown events or click
  ...
  }, [messages, activeUser, notifications, dispatch]);
    ...
    <>
      {activeChat ? (
        <div className={props.className}>
          ...
          <div className="scrollbar-hide w-[100%] h-[70vh] flex flex-col overflow-y-scroll p-4">
          ...
          <div className="absolute left-[31%] bottom-[8%]">
            ...
            <div className="border-[1px] border-[#aabac8] px-6 py-3 w-[360px] sm:w-[400px] h-[50px] rounded-t-[10px]">
            ...
            <div className="border-x-[1px] border-b-[1px] bg-[#f8f9fa] border-[#aabac8] px-6 py-3 w-[360px] sm:w-[400px] h-[50px] rounded-b-[10px]">
